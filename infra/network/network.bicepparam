...
param vnetObject = {
  ...
  subnetsArray: [
    ...
    {
      name: '#{{ environment }}#{{ project }}#{{ nc-function-network }}#{{ nc-resource-subnet }}#{{ subscriptionNumber }}#{{ regionNumber }}03'
      addressPrefix: '#{{ vnet01Subnet3Address }}' // Replace with actual address prefix
      privateLinkServiceNetworkPolicies: 'Enabled' // Set as needed
      delegations: [
